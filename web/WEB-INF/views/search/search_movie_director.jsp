    ...
    <div id="main">
        <div class="inner">
            ...
            <section>
                ...
                <section id="search_movie_director" class="alt">
                    <form method="post" action="Search_movie_director.jsp#">
                        <input type="text" name="search_movie_director" id="movie_director" placeholder="Search">
                    </form>
                    <ul class="actions">
