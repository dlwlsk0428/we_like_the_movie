    ...
    <div id="main">
        <div class="inner">
            ...
            <section>
                ...
                <section id="search_movie_genre" class="alt">
                    <form method="post" action="Search_movie_genre.jsp#">
                        <input type="text" name="search_movie_genre" id="movie_genre" placeholder="Search">
                    </form>
                    <ul class="actions">
