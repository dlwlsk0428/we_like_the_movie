    ...
    <div id="main">
        <div class="inner">
            ...
            <section>
                ...
                <section id="search_movie_title" class="alt">
                    <form method="post" action="Search_movie_title.jsp#">
                        <input type="text" name="search_movie_title" id="movie_title" placeholder="Search">
                    </form>
                    <ul class="actions">
